...
def show_info(functionNode,ModuleName,classobj=""):
    ...
    if classobj != "":
    	...
    	if funcobj.__doc__ != None:
    		str_ += "    Function "+ functionNode.name +"("+ ','.join(Parameters) +") -> Description: " + funcobj.__doc__ + "\n"
    	else:
    		str_ += "    Function "+ functionNode.name+"("+ ','.join(Parameters) +")" + "\n"
    else:
...
def generateModuleFunctionUsageString(ModuleName):
    ...
    for class_ in classes:
        ...
        if classobj.__doc__ != None:
        	full_string += "Class " + class_.name + " -> Description: " + classobj.__doc__ + "\n"
        else:
        	full_string += "Class " + class_.name + "\n"
...
def generateDirFunctionUsageString():
    ...
    for ModuleName in __all__:
        if ModuleName != "__init__" and ModuleName != basename(__file__):
